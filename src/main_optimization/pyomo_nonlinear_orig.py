Revise the calculation of the CAPEX and AOC in the following optimization model. The CAPEX and AOC equations should not be hardcoded. They should be parsed from `capex_calc`:
